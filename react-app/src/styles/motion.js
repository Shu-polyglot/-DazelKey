...
/*
  Life Archive — the featured story card's text block (StoryCarousel's
  StoryCardText) crossfades through this on every swap: a quick fade+
  settle, independent of the card's own layoutId-driven position/size
  morph (see storyCarouselEffects.js) so text never visually follows the
  card's move.
*/
